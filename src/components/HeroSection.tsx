        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          ...
          <div className="relative group animate-scale-in">
            <img
              ...
              className="w-full max-w-sm md:max-w-md rounded-2xl shadow-2xl transition-all duration-300 ease-out transform group-hover:scale-105 group-hover:rotate-1 group-hover:shadow-3xl"
              loading="eager"
              fetchPriority="high"
              decoding="async"
                onError={(e) => {
